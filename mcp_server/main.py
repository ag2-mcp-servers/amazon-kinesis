...
@app.post(
    ...
    tags=['stream_management', 'stream_operations', 'consumer_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['stream_management', 'stream_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def decrease_stream_retention_period(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DecreaseStreamRetentionPeriodInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Deletes a Kinesis data stream and all its shards and data. You must shut down any applications that are operating on the stream before you delete the stream. If an application attempts to operate on a deleted stream, it receives the exception <code>ResourceNotFoundException</code>.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> <p>If the stream is in the <code>ACTIVE</code> state, you can delete it. After a <code>DeleteStream</code> request, the specified stream is in the <code>DELETING</code> state until Kinesis Data Streams completes the deletion.</p> <p> <b>Note:</b> Kinesis Data Streams might continue to accept data read and write operations, such as <a>PutRecord</a>, <a>PutRecords</a>, and <a>GetRecords</a>, on a stream in the <code>DELETING</code> state until the stream deletion is complete.</p> <p>When you delete a stream, any shards in that stream are also deleted, and any tags are dissociated from the stream.</p> <p>You can use the <a>DescribeStreamSummary</a> operation to check the state of the stream, which is returned in <code>StreamStatus</code>.</p> <p> <a>DeleteStream</a> has a limit of five transactions per second per account.</p> """,
...
def deregister_stream_consumer(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DeregisterStreamConsumerInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['stream_operations', 'shard_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def describe_stream(
    ...
    exclusive_start_shard_id: Optional[str] = Query(
        None, alias='ExclusiveStartShardId'
    ),
...
def describe_stream_consumer(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DescribeStreamConsumerInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Provides a summarized description of the specified Kinesis data stream without the shard list.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> <p>The information returned includes the stream name, Amazon Resource Name (ARN), status, record retention period, approximate creation time, monitoring, encryption details, and open shard count. </p> <p> <a>DescribeStreamSummary</a> has a limit of 20 transactions per second per account.</p> """,
    tags=['stream_metrics'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    description=""" <p>Disables enhanced monitoring.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> """,
    tags=['stream_metrics', 'stream_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def disable_enhanced_monitoring(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: DisableEnhancedMonitoringInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description=""" <p>Enables enhanced Kinesis data stream monitoring for shard-level metrics.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> """,
    tags=['stream_metrics', 'stream_encryption_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def enable_enhanced_monitoring(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: EnableEnhancedMonitoringInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def increase_stream_retention_period(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: IncreaseStreamRetentionPeriodInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['consumer_management', 'stream_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['stream_operations', 'stream_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    description=""" <p>Lists the tags for the specified Kinesis data stream. This operation has a limit of five transactions per second per account.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> """,
...
def register_stream_consumer(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: RegisterStreamConsumerInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def remove_tags_from_stream(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: RemoveTagsFromStreamInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['stream_encryption_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def start_stream_encryption(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: StartStreamEncryptionInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def stop_stream_encryption(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: StopStreamEncryptionInput = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    description="""  Updates the capacity mode of the data stream. Currently, in Kinesis Data Streams, you can choose between an <b>on-demand</b> capacity mode and a <b>provisioned</b> capacity mode for your data stream.  """,
    tags=['stream_management', 'stream_operations', 'consumer_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
